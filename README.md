# 🚀 Lộ trình: Từ JavaScript Cơ Bản đến ReactJS Master
...
- **[Phần 3: JavaScript Nâng Cao & Bất Đồng Bộ](./Part3_Advanced)**
  ...
  - Gọi API lấy dữ liệu từ Server (Fetch API).
...
- **[Phần 4: Pre-React](./Part4_PreReact)**
  - Những mảnh ghép cuối cùng cần thiết.
  - ES6 Modules (Import/Export).
  - Spread & Rest Operators (...).

- **[Phần 5: ReactJS Cơ Bản](./Part5_ReactBasic)**
  - "Hello World" với React & Vite.
  - **Components**: Tư duy chia nhỏ giao diện.
  - **Props & State**: Dòng chảy dữ liệu trong ứng dụng.

- **[Phần 6: ReactJS Nâng Cao & Thực Chiến](./Part6_ReactAdvanced)**
  - **useEffect**: Quản lý vòng đời và Side Effects.
  - **Custom Hooks**: Tự xây dựng Hook riêng.
  - **Final Project**: Xây dựng ứng dụng **Weather App** hoàn chỉnh.
